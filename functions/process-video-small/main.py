...
PROCESSOR_TYPE = os.environ.get('PROCESSOR_TYPE', 'cloud-function')
...
def process_video(request):
    """
    HTTP Cloud Function to process small video files.
    ...
    try:
        ...
        return (json.dumps({'status': 'success', 'jobId': job_id}), 200)
